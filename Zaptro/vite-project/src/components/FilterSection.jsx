...
const FilterSection = ({search,setSearch, brand, priceRange, setBrand,setPriceRange,category,setCategory,handleCategoryChange, handleBrandChange}) => {
  ...
  return (
    ...
    <select name="" id="" 
      ...
      <div className='flex flex-col gap-2'>
                ...
                <input type="range" min="0" max="5000" name="" id="" value={priceRange[1]}  className='transition-all' onChange={(e)=>setPriceRange([priceRange[0], Number(e.target.value)])}/>
                {/* value={priceRange[1]}  */}
             </div>
